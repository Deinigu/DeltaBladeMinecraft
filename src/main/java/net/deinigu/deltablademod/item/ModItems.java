...
public class ModItems {
    ...
    public static final RegistryObject<SwordItem> ACTUALLY_BLADE = ITEMS.register("actually_blade",()->new ActuallyBladeItem(Tiers.IRON,1, 1.0f,new Item.Properties().tab(ModCreativeModeTab.ITEMS_TAB)));
