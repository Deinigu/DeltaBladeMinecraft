...
public class ModItems {
    ...
    public static final RegistryObject<Item> DELTABLADE = ITEMS.register("deltablade",()->new DeltaBladeItem(ModTiers.DELTATIER,12,1.6f,new Item.Properties().tab(ModCreativeModeTab.ITEMS_TAB)));
